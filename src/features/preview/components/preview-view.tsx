...
export const PreviewView = ({ projectId }: { projectId: Id<"projects"> }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      <nav className="h-8.75 flex items-center border-b bg-sidebar shrink-0">
        <Button
          size="sm"
          variant="ghost"
        ...
        <Allotment vertical>
          ...
          {showTerminal && (
            ...
            <Allotment.Pane minSize={100} maxSize={500} preferredSize={200}>
              <div className="h-full glex flex-col bg-background border-t">
                <div className="h-7 flex items-center px-3 text-sm gap-1.5 text-muted-foreground border-b border-border/50 shrink-0">
                  <TerminalSquareIcon className="size-3" />
                  Terminal
                </div>
