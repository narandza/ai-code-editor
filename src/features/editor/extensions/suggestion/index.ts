...
const generatePayload = (view: EditorView, filename: string) => {
  ...
  const previousLinesToFetch = Math.min(5, currentLine.number - 1); // TODO: Magic number
  ...
  const linesToFetch = Math.min(5, totalLines - currentLine.number); // TODO: Magic number
